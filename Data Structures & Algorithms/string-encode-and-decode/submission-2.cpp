// Uses non-printable ASCII control characters to prevent data collisions:
// \036 (Record Separator) marks a completely empty vector [].
// \037 (Unit Separator) acts as the delimiter.
